...
- Earned Senior NCO of the Month (May 2025) at the deployed organization and Senior NCO of the Quarter (I) at the home organization (Q1 2025).
...
- Selected to fill the Flight Chief role for 29 personnel across seven technical specialties, ensuring operations continuity across disciplines.
...
## Manager, Client Systems → (Acting) Department Lead, Cyber Operations → Manager, IT Projects (NCOIC → (Acting) Section Chief → NCOIC)

**Sep 2021 – Nov 2022**<br>8th Communications Squadron · Kunsan AB, South Korea

Across a single ~14-month Korea tour, moved through three offices as responsibilities expanded — client-systems help-desk leadership; acting Cyber Operations section chief, selected one rank up to lead a 50-person section spanning Client Systems, Server Operations, Vulnerability Management, and the Help Desk; and IT Projects. Directed 26 personnel resolving 2,000+ IT tickets annually, enabled use of $2.4B in infrastructure for 126 senior leaders, and led installation-wide projects advancing a $35M network and 7,200 systems for 3,100 joint-force users. Because the offices overlapped, all accomplishments below are presented as one combined record.
...
- Maintained 100% inventory accountability across 20,000 devices worth $12M; mentored a direct report to early promotion — and earned NCO Technician of the Quarter (I).
...
- Graduated Distinguished Graduate (top 10%) from the Air Force's first-line supervisor leadership school, organizing study plans for a 27-member class.
...
- Developed a centralized administrative-tools solution and guided 17 technicians — saving 7,000 labor-hours across 753 tickets — applying coursework from a concurrently earned associate degree in Information Systems Technology.
...
- Ran on-the-job training for 28 personnel, applying coursework from concurrent associate-degree studies (3.8 GPA across 12 credit hours).
...
- Enforced the base removable-media policy, quality-checking 60 hard-drive whitelist requests — protecting the $318M network and earning Airman of the Quarter (II).
