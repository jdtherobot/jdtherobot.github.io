...
*48th Intelligence Support Squadron · October 2025 – Present*
...
*Expeditionary Communications Squadron · April 2025 – October 2025*
...
- Recognized as top senior manager of the month (deployed organization) and top senior manager of the quarter (home organization) during the same period.

---

## Oct 2024 – Apr 2025 · Beale AFB, California

### Division Lead, Plans & Requirements

*48th Intelligence Support Squadron · October 2024 – April 2025*
...
- Founded the installation's first Computer Science Club, authoring hands-on curriculum in Linux administration, shell scripting, Python, penetration-testing fundamentals, and embedded systems; facilitated weekly peer-led instruction and co-designed an internal capture-the-flag (CTF) training environment with a red-team-experienced cybersecurity officer.
- Completed 28 credit hours toward a B.S. in Computer Science while serving as senior advisor to a 100+ member professional association chapter and organizing a leadership offsite; drove four professional development sessions and mentored 10 senior managers.

---

## Nov 2022 – Oct 2024 · Beale AFB, California

### Department Lead, Project Management

*48th Intelligence Support Squadron · November 2022 – October 2024*
...
## Mar – Nov 2022 · Kunsan AB, South Korea

### Manager, IT Projects

*8th Communications Squadron · March 2022 – November 2022*

Directed 26 personnel resolving more than 2,000 IT tickets annually, enabling use of $2.4B in infrastructure and supporting 126 senior leaders. Led installation-wide technology projects advancing a $35M network environment and 7,200 systems for 3,100 joint-force users.
...
- Diagnosed and repaired eight critical systems supporting an $88.2M fuels-management program, averting an operational shutdown.
- Executed a mobile-credentialing (secure smartphone authentication) rollout to 192 devices, giving senior leaders 24/7 secure mobile access ahead of the chief information officer's mandated deadline.
- Handled two no-notice emergency security directives, working with headquarters organizations to remediate network vulnerabilities and confirm compliance — no intrusions.
- Supported the installation's first F-35 fighter reception in over five years, shaping a $108M maintenance project and contingency communications plans.
...
- Selected for a 12-week leadership academy; hosted 11 professional development seminars training 148 personnel on career skills.
- Completed five courses and 22 credit hours toward a B.S. in Computer Science; engineered two of the organization's three top-priority technical solutions, supporting operations for 4,400 flight missions.
...
- Performed a senior manager's role (two grades up) for three months, leading a 50-person cyber operations section: cleared 2,000 tickets and 207 compliance orders at the #1 completion rate in the Pacific command — earning the 2021 Team of the Year award.
...
- Volunteered as first-aid program monitor to prevent a training shortfall, managing seven instructors — 99% of the organization qualified in life-saving skills.
...
- Anchored the antiterrorism program, refining the training plan and running 12 random security measures — protecting six sites and 938 communications circuits.
- Stood up and maintained a four-member rapid-response communications team, validating 92 contingency requirements for 24/7 wartime readiness.
- Managed mobility logistics procuring 2,500 items ($67K), equipping forces for two major commands — a key contribution to the Afghanistan withdrawal effort.
- Launched the organization's transition to a new tactical combat casualty care standard, identifying instructors and coordinating initial qualifications for a 250-member rollout.
- Partnered with headquarters planners to update real-world threat information, facilitating eight briefings that raised organizational understanding of regional strategy.
- Led the base Honor Guard as manager for three months — 26 personnel, 78 training hours, 23 ceremonies — and mentored five early-promotion and one quarterly-award winner.
- Organized nine volunteers as the organization's federal-charity representative, achieving 100% contact across 250 members for the largest federal workplace-giving campaign.
- Modernized readiness operations: trained two successor managers and certified 185 members in operate-under-attack skills — raising the defense-readiness rate from 91% to 95%.
- Executed the organization's transition to a new deployment-planning system, completing 45 force-flow requirements with zero findings — beating the service-wide 95% compliance standard.
- Ran the official passport program in coordination with the U.S. State Department, creating a unit guide that eliminated deployment delays for 15 members.
- Managed rapid-response communications kits with the operations group: deployed 12 personnel and 600 lbs of equipment supporting three exercises, enabling no-notice emergency command-and-control support across the region; created a new deployment package readying four members to deploy within 24 hours.
...
- Revitalized the installation's iPhone program, coordinating five offices and streamlining contract justifications — awarding 404 contracts worth $225.7K.
- Overhauled the radio lifecycle plan, identifying 306 assets for redistribution or disposal — eliminating a three-year backlog and recouping $815K.
- Led the year-end IT purchasing process, vetting 158 requests-for-quote and approving $3M in upgrades — refreshing 6,000 organizational assets in under a month.
- Resolved a smartphone OS crisis across 26 organizations, upgrading 108 devices and preventing service outages for 81 senior executives.
- Streamlined equipment-management processes with 33 new standard procedures and training for 8 staff — cutting delivery time from three months to one.
- Managed migration of 50,000 devices across 154 accounts into the Department of Defense's asset-tracking system in two months instead of three — aligning $20M in equipment with federal requirements.
- Led six staff as the infrastructure-planning subject-matter expert: vectored 304 work orders and purchased 1,400 devices, enabling $1.5M in IT modernization for 57 organizations.
- Updated equipment turn-in guidance for the excess-property program, improving service for 152 account custodians and disposing of 3,100 devices.
- Directed the executive communications support team for a major exercise: cleared 134 tickets and built 325 accounts, enabling 4,000 flight-training hours — commended by three general officers.
- Maintained 100% inventory accountability across 20,000 devices worth $12M; mentored a direct report to early promotion — and earned Technician of the Quarter.
- Named the installation's Honor Guard Member of the Year (2019): as assistant manager, wrote five performance evaluations and trained 63 ceremonial guardsmen while serving 271 hours across 141 events; completed 120 hours of advanced training in protocol, ceremonies, and military funeral honors.
...
- Managed asset accountability for the installation-wide Windows 10 upgrade — 9,900 systems across 39 organizations, $21.9M — validating compliance a full month ahead of the Department of Defense deadline.
- Quarterbacked a storage-efficiency effort that purged 283,000 files (332 GB) from shared drives — cutting information search time from 15 minutes to 30 seconds.
- Authored six standard procedures and quick-reference guides for 331 equipment custodians across 48 remote sites — eliminating 210 hours of redundant training annually.
- Installed the installation's first fingerprint-scanner link to the FBI headquarters database for law-enforcement offices — supporting 100+ investigations per year.
- Executed a major desktop-image update, coordinating 40 custodians and 24 accounts to distribute 334 systems — resolving an outage and modernizing a $57M network.
- Partnered with the finance service office to field a dedicated finance-system workstation, eliminating recurring staff travel — processing $8M in travel vouchers and saving 1,200 labor-hours.
- Served in the exercise control cell for a major bilateral exercise, tracking events and relaying operations-center status for a 57,000-person command.
- Revamped the technician training program, updating 259 core tasks and standardizing the qualification guide — taking 27 technicians' training records from failing to excellent.
- Prepped an eight-member team for a national Japanese-language competition over seven weeks — the team placed 2nd nationally.
- Graduated in the top 10% of the Air Force's first-line supervisor leadership school as a Distinguished Graduate, organizing study plans for a 27-member class.
- Led a five-person classified-network OS upgrade, organizing security scans and equipping 44 workstations to maintain security standards.
- Certified a new inventory-adjustment policy for 156 accounts and trained 331 custodians — eliminating a 50-day loss-investigation process.
- Directed 534 work-order requests across 18 technicians and five work centers — 95% closed in under 21 days, contributing to the Air Force's "Best Large Communications Squadron" award (2018).
...
- Administered weekly travel-system updates maintaining the link between installation finance and headquarters — supporting 3,000 vouchers and $95K in fund distribution.
- Led a four-technician IT refresh of the professional development center, replacing 29 legacy systems — enabling classes for 425 students and 74 evaluees annually.
- Executed a network relocation for the base ceremonial unit, leading three technicians to configure two switches and install 14 systems — supporting scheduling for 100 events.
- Piloted laptop upgrades for the installation's investigative office, deploying 20 Windows 10 laptops that enhanced operations for 16 agents.
- Resolved a critical workstation failure for the operations commander, restoring air-traffic-control oversight of 8,500 square miles of airspace and 3,300 flights.
- Created offline "deployer kits" — three standalone laptops giving contract officers a mobile office for expeditionary operations.
- Selected to brief six organizations at a group awards ceremony on regional operational priorities.
- Cross-trained with the infrastructure cabling team: transferred a munitions facility's 34 assets and ran fiber-optic cable, protecting oversight of a $323M stockpile.
- Completed an associate degree in Information Systems Technology while working full time; applied coursework to guide 17 technicians and develop a centralized administrative-tools solution — saving 7,000 labor-hours across 753 tickets.
- Installed network hardware enabling a tool-tracking system for the maintenance organization — securing accountability for equipment supporting a $1.5B aircraft fleet.
- Drove resolution of a passenger-terminal network outage, installing four printers and a print server — restoring travel processing for 23,000 passengers and 115 flights yearly.
- Organized the backup emergency-operations-center communications build-out, leading seven technicians to install 27 systems — delivering command-and-control for a 48-member disaster-response team.
...
- Ran the base service-desk queue: processed 1,940 tickets with the best open-to-close ratio in the squadron — earning the career field's Airman of the Year and a team-of-the-year award.
- Drove a classified-network outage fix with the enterprise network center, isolating a faulty policy and registry error — restoring service for 1,000 users supporting a critical air mission.
- Served as point person for a base-wide web-services repair, coordinating with headquarters and three work centers — restoring service for 6,500 users and oversight of $88M in construction projects.
- Resolved an authentication-server error, organizing nine technicians to reconfigure 53 multi-function printers — restoring scan-to-email for 30 organizations.
- Managed the executive smartphone program, fielding 25 devices that gave senior leaders secure mobile access.
- Trained the client-systems technician workforce: guided 16 technicians, certified 86 job tasks, and authored 13 standard procedures.
- Deployed to Alaska as communications support for a major international exercise, servicing 21 classified accounts — enabling operations for 80 U.S. and Canadian aircraft across 232 flights.
- Created a squadron IT newsletter with 32 validated how-to guides and policies, reaching 6,000 users — a contributor to two team-of-the-quarter awards.
- Saved a munitions-tracking audit by installing a critical system less than two hours before the deadline — securing accountability for 3,300 rounds.
- Earned 12 college credit hours with a 3.8 GPA while completing associate-degree requirements; used the coursework to run on-the-job training for 28 personnel.
- Rebuilt the base education-testing center, baselining the master console and reconfiguring the e-exam platform — restoring service for 5,000 test-takers and 650 courses annually.
- Enforced the base removable-media policy, quality-checking 60 hard-drive whitelist requests — protecting the $318M network and earning Airman of the Quarter.
- Volunteered 20 hours as a designated driver across three weekends, helping prevent 16 alcohol-related incidents.
...
- Resolved 221 trouble tickets and 29 work orders — supporting 6,000 customers with 99% system availability and 24/7 network connectivity.
- Restored a compliance-marking capability for the maintenance organization by configuring an industrial marking plotter — returning a $1.4B aircraft fleet to OSHA/FAA labeling compliance.
- Rewired six phone lines for the munitions control center, restoring operations supporting a $350M stockpile.
- Configured 14 vehicle-management workstations, enabling processing of 2,700 work orders and 11,900 vehicle repairs per year.
- Recovered the operations commander's traveling laptop, restoring VPN connectivity and global reach-back to command networks.
- Relocated and installed eight phone lines for the maintenance operations center — supporting 5,100 aircraft status updates and 1,000 fuel-service calls per year.
- Co-led an IT move for a binational aviation-training program, migrating 40 devices with zero disruption across 167 training missions.
- Supported the 64-bit/Windows 10 readiness initiative: completed 61 data backups, imaged 72 computers, and configured 23 applications.
- Led a three-member cabling team through a personnel-services building renovation — 14 phone lines and 11 workstations — restoring pay support for 6,500 personnel.
- Migrated seven phone lines for a quality-assurance office renovation, sustaining oversight of a $256B engine fleet program.
- Fixed a flight-operations phone outage by isolating a daisy-chain wiring fault — protecting scheduling for 7,300 flights and 10,000 flight hours annually.
- Provided public-address and audio-visual support for base community events serving 350 personnel, and volunteered with a host-nation charity program supporting elderly, disabled, and orphaned residents.
...
- Raised $3.2K for quality-of-life programs through dormitory-council fundraising, and volunteered at community events strengthening U.S.–Korean relations.
