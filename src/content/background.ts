...
export type Certification = {
  ...
  logo?: 'mit' | 'cissp' | 'security-plus' | 'a-plus' | 'linux-essentials'
...
export const CERTIFICATIONS: Certification[] = [
  { name: 'CISSP', issuer: 'ISC2', year: '2026', logo: 'cissp', credId: '3120559', verify: 'https://www.isc2.org/verify' },
  ...
  { name: 'Linux Essentials', issuer: 'Linux Professional Institute (LPI)', year: '2026', logo: 'linux-essentials', credId: 'LPI000681445', verify: 'https://cs.lpi.org/caf/Xamman/certification/verify/LPI000681445/tdgdblba2u' },
  { name: 'CompTIA A+', issuer: 'CompTIA', year: '2014', logo: 'a-plus', credId: '2K9CBW6E3KVESYK8', verify: 'https://verify.comptia.org' },
  { name: 'CompTIA Security+', issuer: 'CompTIA', year: '2016', logo: 'security-plus', credId: '5W37E4LMFDQ419R1', verify: 'https://verify.comptia.org' },
